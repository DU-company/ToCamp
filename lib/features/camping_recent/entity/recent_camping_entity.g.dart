...
part of 'recent_camping_entity.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

RecentCampingEntity _$RecentCampingEntityFromJson(Map<String, dynamic> json) =>
    RecentCampingEntity(
      ...
      createdAt:
          RecentCampingEntity._intToTime((json['createdAt'] as num).toInt()),
    );

Map<String, dynamic> _$RecentCampingEntityToJson(
        RecentCampingEntity instance) =>
    <String, dynamic>{
      'id': instance.id,
      ...
      'createdAt': RecentCampingEntity._timeToInt(instance.createdAt),
    };
