...
import 'package:to_camp/features/common/widgets/mini_card/camping_mini_card.dart';
import 'package:to_camp/features/common/widgets/mini_card/mini_card_loading_view.dart';
import 'package:to_camp/core/models/pagination_state.dart';

class MiniCardListView extends ConsumerWidget {
  final PaginationStateV2 state;
  ...
  Widget body(WidgetRef ref) {
    if (state is PaginationErrorV2) {
      final pState = state as PaginationErrorV2;
